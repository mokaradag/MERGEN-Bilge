  ...
  moduleServer(id, function(input, output, session) {
    ...
    observeEvent(input$gonder_geri_bildirim, {
      ...
      tryCatch({
        ...
        shinyjs::runJs(sprintf(
          "document.getElementById('%s').textContent = 'De\\u011ferli geri bildiriminiz i\\u00e7in te\\u015fekk\\u00fcrler. Fikirleriniz, \\u00fcr\\u00fcn\\u00fcm\\u00fcz\\u00fcn gelece\\u011fini \\u015fekillendiriyor.';",
          ns("basari_mesaji")
        ))
    ...
    observeEvent(hata_result$basarili(), {
      ...
      shinyjs::runJs(sprintf(
        "document.getElementById('%s').textContent = 'Hata bildiriminiz ba\\u015far\\u0131yla sistemimize kaydedildi. M\\u00fchendislik ekibimiz en k\\u0131sa s\\u00fcrede inceleyecektir.';",
        ns("basari_mesaji")
      ))
      shinyjs::hide("sekme_geri_bildirim")
      shinyjs::hide("sekme_hata")
