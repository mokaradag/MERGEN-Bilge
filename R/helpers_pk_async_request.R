...
pk_async_worker_globals <- function(force = FALSE) {
  ...
  paket <- list(
    ...
    # Repo kökü / dosya varlığı denetimleri de SINIRLI sarmalayıcıdan geçer;
    # yardımcı bootstrap'ın İLK satırlarında çağrılır.
    pk_async_bounded_path_exists = pk_async_bounded_path_exists,
