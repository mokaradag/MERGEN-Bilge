...
pk_sql_describe_result_schema <- function(conn, sql_text, call_fn = NULL) {
  ...
  sorgu <- paste(
    "SELECT name, system_type_name, max_length, error_type",
  ...
  # HATA SATIRI TANIMLAYICI DEĞİLDİR: betimleyici yok sayılır ve çağıran
  # (kanıtlanmamış genişlik) yoluna düşer.
