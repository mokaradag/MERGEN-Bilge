...
test_that("UI sayfa ve deferred manifest bölümleme sırası birebir korunur", {
  ...
  expected_page_css <- c(
    ...
    # Oda odaklı stiller (seçici/avatar/baloncuk) ve Bilge Yolaç çalışma alanı
    # paneli stilleri AYRI dosyalarda (frontend ratchet tek dosya satır bütçesi);
    # ortak_oturumlar.css hemen ardından yüklenirler.
