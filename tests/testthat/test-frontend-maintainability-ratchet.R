...
test_that("frontend JS/CSS büyüklük ve yoğunluk bütçeleri sessizce aşılmaz", {
  ...
  # 1150L -> 1490L bilinçli güncelleme: Ortak Çalışmalarım UX iyileştirme seti
  # www/css/ortak_oturumlar.css'yi büyüttü (sürüklenebilir yan panel ayracı, sekme
  # filtre çubuğu, kompakt model/persona composer satırı, sakin buton/rozet dili,
  # profesyonel oturum kartları, Yeni Ortak Oturum modalı radyoları, yoklama-donma
  # giderme). 1500+ satır dosya sayısı 0 KORUNUR (dosya 1485 satır); yalnızca en
  # büyük CSS dosyası tavanı yükseldi (sessiz büyüme değil bilinçli genişleme).
  max_css_lines_all <- .as_int_env_frontend("MERGEN_TEST_MAX_FRONTEND_CSS_LINES", 1490L)
  ...
  # 850L -> 903L bilinçli güncelleme: AI Uzman parçalı TTS oynatma yaşam döngüsü
  ...
  max_app_js_lines <- .as_int_env_frontend("MERGEN_TEST_MAX_FRONTEND_APP_JS_LINES", 903L)
