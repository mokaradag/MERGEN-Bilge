...
test_that("gunluk dosya appender'i uzun calisan surecte tarihi yeniden cozer", {
  # Haziran regresyonunun kok nedeni: dosya yolu yalnizca acilista bir kez
  # cozuluyordu. Bu test, appender'in her log satirinda guncel tarihi yeniden
  # cozdugunu (gece yarisi devri) dogrular.
  ...
  # Surec acik kalirken takvim gunu ilerler; ayni surec yeni gune yazmalidir.
