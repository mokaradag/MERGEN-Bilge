...
test_that("ön yüz seçici sözleşmeleri güncel UI ile hizalı kalır", {
  ...
  modern_welcome_handler_js <- .read_repo_text_frontend_selector_contract("www/js/modern_welcome_handler.js")
  ...
  expect_true(.frontend_selector_has_text(modern_welcome_handler_js, "Shiny.addCustomMessageHandler('initModernWelcome'"))
