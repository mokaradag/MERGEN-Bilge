...
test_that("v1 butce ALTINDA kalan yuk BIREBIR degismez", {
  ...
  # yalitim yalnizca `mergen.pk.prompt_char_budget` SECENEGINI temizler. Kucuk
  # bir `MERGEN_PK_PROMPT_CHAR_BUDGET` tanimlayan bir VM/CI kabugunda kirpma
  # tetiklenir ve "kirpma yok" iddiasi URETIM DOGRU oldugu halde duserdi.
  testthat::skip_if_not_installed("withr")
  yuk <- withr::with_envvar(list(MERGEN_PK_PROMPT_CHAR_BUDGET = NA_character_), {
    env$pk_build_analysis_payload(
