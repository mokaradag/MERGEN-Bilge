...
test_that("file manager policy ve UI yardımcıları dosya yöneticisi sunucu modülünden önce yükleniyor", {
  ...
  expect_false(is.na(pos("R/helpers_file_manager_upload_runtime.R")))
  ...
  expect_lt(pos("R/helpers_file_manager_storage.R"), pos("R/helpers_file_manager_upload_runtime.R"))
  expect_lt(pos("R/helpers_file_manager_upload_runtime.R"), pos("R/helpers_file_manager_delete_runtime.R"))
