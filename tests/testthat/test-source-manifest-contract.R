...
test_that("kritik yardımcılar modüllerden önce yükleniyor", {
  ...
  expect_lt(pos("R/module_user_identity.R"), pos("R/server_init_user_session.R"))
  expect_lt(pos("R/server_init_forward_refs.R"), pos("R/server_init_user_session.R"))
  expect_lt(pos("R/server_init_user_session.R"), pos("R/server_init_session_state.R"))
  expect_lt(pos("R/server_init_user_session.R"), pos("R/server_init_chat_runtime.R"))
