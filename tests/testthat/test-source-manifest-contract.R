...
test_that("kritik yardımcılar modüllerden önce yükleniyor", {
  ...
  expect_lt(pos("R/server_chat_engine_dependencies.R"), pos("R/server_init_session_state.R"))
  expect_lt(pos("R/server_chat_engine_dependencies.R"), pos("R/server_init_chat_runtime.R"))
