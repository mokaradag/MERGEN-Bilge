...
test_that("kritik yardımcılar modüllerden önce yükleniyor", {
  ...
  expect_lt(pos("R/helpers_mcp_basic_tools.R"), pos("R/helpers_chartlab.R"))
...
test_that("file manager policy ve UI yardımcıları dosya yöneticisi sunucu modülünden önce yükleniyor", {
  ...
  expect_lt(pos("R/helpers_file_manager_policy.R"), pos("R/helpers_file_manager_table.R"))
  ...
  expect_lt(pos("R/helpers_file_manager_session_registry.R"), pos("R/module_file_manager_ui.R"))
