...
Assert-Contains $runBatText 'set\s+"MERGEN_LOG_DIR=%APP_DIR%logs"' "run_mergen_prod.bat pins MERGEN_LOG_DIR to the app logs folder"
Assert-Contains $runBatText 'mergen_%MERGEN_LOG_DATE%\.log' "run_mergen_prod.bat bootstraps the daily mergen_YYYYMMDD.log file"
Assert-Contains $runBatText 'run_mergen_prod_console\.log' "run_mergen_prod.bat captures startup diagnostics in run_mergen_prod_console.log"
