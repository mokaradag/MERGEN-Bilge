...
Assert-Contains $runBatText 'Tee-Object\s+-FilePath\s+\$env:MERGEN_CONSOLE_LOG\s+-Append' "run_mergen_prod.bat tees R console output into the daily mergen_YYYYMMDD.log file"
