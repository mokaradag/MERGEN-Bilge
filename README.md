...
24 Haziran 2026 Windows VM limit-push güncellemesi: havuz açıkken (`MERGEN_DB_POOL_ENABLED=TRUE`, min=1, max=8, idle timeout=600 sn, validation interval=60 sn) 1000 aktif eşzamanlı kullanıcı / 5400 saniye proxy-lane attach koşumu hâlâ **FAIL** oldu (`effective_success_rate=0.6414` < 0.98), ancak 20 Haziran baseline'ına göre başarı oranı 0.5826'dan 0.6414'e yükseldi ve timeout sayısı 94880'den 73552'ye indi. Bu sınırlı iyileşme kapasite/readiness PASS kanıtı değildir; ayrıntılar operational soak belgesindedir.
