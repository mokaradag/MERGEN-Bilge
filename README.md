...
- **DevTools eski/gruplu sayaç notu:** Bu düzeltmelerden sonra Chrome DevTools bazen canlı hata kalmasa da eski bir gruplu “1 error” / “<other>” sayacı gösterebilir. Konsolda canlı hata yoksa, Network’te failed request görünmüyorsa ve probe da resource/runtime hatası üretmüyorsa bunu uygulama regresyonu değil DevTools grouping/cache/state artığı olarak değerlendirin; ancak tekrar üretilebilir kaynak URL’i, hatalı DOM öğesi, stack trace veya Network hatası varsa gerçek sorun olarak ele alın.
