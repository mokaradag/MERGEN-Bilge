...
25 Haziran 2026 Windows VM kademeli soak güncellemesi: 50 aktif proxy kullanıcı / 1800 sn PASS, 10 gerçek tarayıcı oturumu browser concurrency lane PASS ve kapasite merdiveninde 100 ile 250 aktif proxy kullanıcı / 90 dk adımları PASS olarak kaydedildi. Son stabil staged kapasite şimdilik 250 aktif proxy kullanıcı / 90 dk; sıradaki hedef 500 adımıdır. Bu sonuçlar 1.000 gerçek aktif insan chat oturumu veya gerçek upstream LLM throughput'u kanıtı değildir; ayrıntılar operational soak belgesindedir.
