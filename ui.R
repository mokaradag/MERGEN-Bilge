        ...
        div(
          class = "chat-header",
			...
			div(
			  ...
			  actionButton("new_chat_btn", label = tagList(icon("plus"), span("Yeni Söyleşi", class = "btn-text")), class = "btn-modern btn-primary"),
            conditionalPanel(
              condition = "!output.show_welcome_screen",
              actionButton("copy_chat_btn", label = tagList(icon("clipboard"), span("Sohbeti Kopyala", class = "btn-text")), class = "btn-modern btn-info")
            ),
            conditionalPanel(
              condition = "!output.show_welcome_screen",
