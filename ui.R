...
ui <- dashboardPage(
  ...
  tags$head(
    ...
    tags$link(rel = "stylesheet", type = "text/css", href = "css/premium_reasoning.css"),
    ...
    tags$link(rel = "stylesheet", type = "text/css", href = "css/settings_model_info.css"),
    ...
    tags$script(src = "js/premium_reasoning.js"),
    ...
    tags$script(src = "js/settings_model_info.js", defer = "defer"),
