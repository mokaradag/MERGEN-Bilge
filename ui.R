...
ui <- dashboardPage(
  ...
  tags$head(
    ...
    # --- Kritik CSS Dosyaları (ilk çizim için gerekli, senkron yüklenir) ---
    ...
    # --- Sohbet Sayfası CSS (ana sayfa, senkron yüklenir) ---
    ...
    # --- Ertelenmiş CSS (sekmeye özel, ilk çizimi engellemez) ---
    # Hoş geldin ekranı stilleri
    tags$link(rel = "stylesheet", type = "text/css", href = "css/welcome_modern.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/welcome_greeting_personal.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/welcome_screen.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/welcome_styles.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/cinematic_intro.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/deep_space_intro.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/mode_selection.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/explore_cinematic.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/explore_character_step.css", media = "print", onload = "this.media='all'"),
    # Sohbet sekmeye özel stiller
    tags$link(rel = "stylesheet", type = "text/css", href = "css/character_video.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/tts_visualizer.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/stt.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/music_slider.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/date_picker.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/pagination_custom.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/animations_extra.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/feedback_modal.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/image_tools.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/summarization_tools.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/code_collapse.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/chat_search_modal.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/analysis_tools.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/citation_styles.css", media = "print", onload = "this.media='all'"),
    # Diğer sekmelere özel stiller
    tags$link(rel = "stylesheet", type = "text/css", href = "css/file_manager.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/history_saved_chats.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/image_gallery.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/settings_page.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/settings_tools.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/health_check.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/destek_page.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/destek_yardim_chatbot.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/admin_destek_analytics.css", media = "print", onload = "this.media='all'"),
    tags$link(rel = "stylesheet", type = "text/css", href = "css/surum_bilgilendirme.css", media = "print", onload = "this.media='all'"),
    ...
    # Çekirdek CodeMirror (senkron — diğer modüller buna bağımlı)
    tags$script(src = "codemirror/codemirror.min.js"),

    # Dil Modları (ertelenmiş — sohbet sekmesinde kod bloğu gösterildiğinde kullanılır)
    tags$script(src = "codemirror/mode/r.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/python.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/javascript.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/sql.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/shell.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/css.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/xml.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/htmlmixed.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/clike.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/php.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/ruby.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/go.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/swift.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/powershell.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/commonlisp.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/vb.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/fortran.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/octave.min.js", defer = "defer"),
    tags$script(src = "codemirror/mode/julia.min.js", defer = "defer"),

    # Eklentiler (ertelenmiş — kod katlaması ve yorum özellikleri için)
    tags$script(src = "codemirror/addon/comment/comment.min.js", defer = "defer"),
    tags$script(src = "codemirror/addon/fold/foldcode.min.js", defer = "defer"),
    tags$script(src = "codemirror/addon/fold/foldgutter.min.js", defer = "defer"),
    tags$script(src = "codemirror/addon/fold/brace-fold.min.js", defer = "defer"),
    tags$script(src = "codemirror/addon/fold/comment-fold.min.js", defer = "defer"),
    tags$script(src = "codemirror/addon/fold/indent-fold.min.js", defer = "defer"),
    tags$script(src = "codemirror/addon/fold/xml-fold.js", defer = "defer"),
