...
(function() {
  ...
  // -------------------------------------------------------------------------
  // 16x16 PİKSEL KARAKTER VERİLERİ
  // Statik frame verileri www/js/claude_code_pixel_chars.js içinde tutulur.
  // Bu dosya yalnızca çalışma zamanı animasyon ve UI davranışını yönetir.
  // -------------------------------------------------------------------------
  var PIXEL_CHARS_MINI = window.MergenClaudeCodePixelCharsMini || {};
