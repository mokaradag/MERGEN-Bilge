...
| [`voxcpm2-ses-profilleri.md`](voxcpm2-ses-profilleri.md) | Beş persona için uygulama-tarafı VoxCPM2 referans-ses profilleri; manifest/WAV doğrulama, bellek/üretilen-ses önbelleği, sınırlı eşzamanlılık, başlangıç ön yükleme politikası, `LOCAL_TTS_*` yapılandırması, dağıtım ve geri dönüş. |
