...
| [`operational-soak-gate.md`](operational-soak-gate.md) | Operasyonel soak/yük kapısı (`run_operational_soak_gate.R`); fake/proxy/real-canary serit tasarımı, profiller, anahtar yönlendirme/izolasyon kanıtı, `artifacts/soak/<timestamp>/` artifact'ları ve 1.000 kullanıcı rollout planı. |
