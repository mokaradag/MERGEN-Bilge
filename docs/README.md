...
| [`vm-evidence-status.md`](vm-evidence-status.md) | En son başarılı Windows VM evidence gate koşumu; 26 Temmuz 2026 tarihli 13/13 geçiş, artifact yolu, browser attach ayarı ve kanıt kapsamı. |
