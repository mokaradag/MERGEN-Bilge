...
| SSO/auth | `R/config_sso.R`, `R/helpers_sso.R`, `R/helpers_sso_jwks_cache.R`, `R/helpers_sso_signature.R`, `R/helpers_logout_url.R` | Yerel geliştirme ve Keycloak/JWT sınırı. |
...
| SSO/JWT sınırı | Üretimde fail-closed davranış ve imza doğrulaması önemlidir. | `R/config_sso.R`, `R/helpers_sso_jwks_cache.R`, `R/helpers_sso_signature.R`, [`../RUNBOOK.md`](../RUNBOOK.md) |
