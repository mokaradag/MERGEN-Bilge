...
| VoxCPM2 ses profilleri | `R/helpers_tts_voice_config.R`, `R/helpers_tts_voice_manifest.R`, `R/helpers_tts_voice_cache.R`, `R/helpers_tts_audio_cache.R`, `R/helpers_tts_request.R`, `R/helpers_tts_queue.R`, `R/helpers_tts_profile_preload.R` (`tts_ses_profilleri` bölümü), `R/module_tts.R` | Beş persona için uygulama-tarafı VoxCPM2 referans-ses klonlama: manifest/WAV doğrulama, profil bellek + üretilen-ses önbelleği, sınırlı eşzamanlılık, başlangıç ön yükleme politikası. Ayrıntı: [`voxcpm2-ses-profilleri.md`](voxcpm2-ses-profilleri.md). |
