...
| `files_preview_pipeline` / `file_manager_helpers` | Dosya yaşam döngüsü, önizleme, Dosya Yönetimi yardımcıları | `R/helpers_file*`, `R/module_file_manager*.R`; delete runtime helper storage sonrası/state runtime öncesi source edilir. |
