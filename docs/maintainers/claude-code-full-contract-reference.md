<!--
REFERENCE ARCHIVE — NOT CLAUDE CODE MEMORY

This file is a verbatim snapshot of the former root CLAUDE.md at blob f4c5f0dc9af920de14d460e1464dc75c6b47ae53.
It intentionally lives under docs/, not as CLAUDE.md and not under .claude/rules/,
so Claude Code does not load ~764 KB of historical detail into every session.

Do not @import this file from CLAUDE.md or an unconditional rule.
Use it only for audit, archaeology, and edge-case investigation.
-->
