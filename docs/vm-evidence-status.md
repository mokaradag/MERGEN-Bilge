...
- **Artifact dizini:** `artifacts/vm-evidence/20260817-065352`
- **Makine-okunur kanıt:** `artifacts/vm-evidence/20260817-065352/evidence.json`
- **Browser external-app URL:** `http://127.0.0.1:8009`
- **Browser smoke zorlaması:** `MERGEN_REQUIRE_BROWSER_UX_SMOKE=true`
- **Kayıt kaynağı:** 17 Ağustos 2026 tarihli Windows VM konsol çıktısı ve operatör ekran görüntüsü
...
| `parse_sanity` | PASSED | 15.1 sn |
| `app_boot_smoke` | PASSED | 43.8 sn |
| `full_testthat` | PASSED | 5280.7 sn |
| `maintainability_report` | PASSED | 19.6 sn |
| `frontend_ratchet` | PASSED | 1071.3 sn |
| `seam_doctor` | PASSED | 1.1 sn |
| `source_manifest_contracts` | PASSED | 12.6 sn |
| `ui_asset_manifest_contracts` | PASSED | 8.8 sn |
| `browser_ux_smoke` | PASSED | 234.5 sn |
| `vm_preflight_real` | PASSED | 56.4 sn |
| `db_encoding_preflight` | PASSED | 40.5 sn |
| `renv_status` | PASSED | 0.0 sn |

Süreler, 17 Ağustos 2026 tarihli konsol çıktısında görülen koşum süreleridir; başka VM koşumlarında değişebilir.
...
`MERGEN_BROWSER_UX_BASE_URL` çalışmakta olan uygulamanın gerçek yerel URL'siyle eşleşmelidir. 17 Ağustos 2026 koşumunda uygulama `8009` portunda çalışıyordu.
