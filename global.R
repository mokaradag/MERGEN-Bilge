...
source("R/helpers_deep_analysis.R", encoding = "UTF-8")
...
source("R/helpers_ai_expert.R",   encoding = "UTF-8")  # AI Uzman yardimci fonksiyonlari
source("R/module_ai_expert.R",    encoding = "UTF-8")  # AI Uzman modulu (altyazi + durum)
source("R/server_ai_expert_handlers.R", encoding = "UTF-8")  # AI Uzman isleyicileri
