...
18 Ağustos 2026 tarihli son VM evidence gate koşumu başarılıdır: `Toplam: 13 passed, 0 failed, 0 skipped`. Son kanıt `artifacts/vm-evidence/20260818-163559/evidence.json` altında beklenir; genel düzen `artifacts/vm-evidence/<timestamp>/evidence.json` olarak kalır. Ayrıntılı son koşum kaydı için [`docs/vm-evidence-status.md`](docs/vm-evidence-status.md) izlenir.
...
2026-06-12 tarihinde Windows VM üzerinde tam evidence gate milestone'u kaydedildi; sonraki başarılı yeniden doğrulamalar 2026-06-15, 2026-07-21, 2026-07-26 ve 2026-07-28 tarihlerinde, en son başarılı yeniden doğrulama ise 2026-08-18 tarihinde alındı:
...
- En son başarılı koşum: `artifacts/vm-evidence/20260818-163559/evidence.json`.
